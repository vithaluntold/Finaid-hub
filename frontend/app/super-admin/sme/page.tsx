        ...
        <Tabs defaultValue="overview" className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
              <Card className="col-span-4">
                <CardHeader>
                  ...
                  <CardDescription>
                    Monthly metrics for SME performance
                  </CardDescription>
                </CardHeader>
              ...
              <Card className="col-span-3">
                <CardHeader>
                  ...
                  <CardDescription>
                    Distribution of Fin(Ai)ds across SMEs
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <SmeDeploymentChart />
            ...
            <div className="grid gap-4 md:grid-cols-1">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Companies with highest Fin(Ai)d adoption
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <SmeList />
          ...
          <TabsContent value="deployment" className="space-y-4">
            <Card>
              ...
              <CardContent>
                <p>
                  Detailed deployment analytics for SMEs will be displayed here.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          <TabsContent value="revenue" className="space-y-4">
            <Card>
              ...
              <CardContent>
                <p>
                  Detailed revenue analytics for SMEs will be displayed here.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          <TabsContent value="companies" className="space-y-4">
            <Card>
              ...
              <CardContent>
                <p>
                  Complete directory of SME companies will be displayed here.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
